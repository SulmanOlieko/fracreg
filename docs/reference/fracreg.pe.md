...
#> Note: Standard errors computed using the Delta method
#>      dy/dx Std. Error z value Pr(>|z|)    
#> X1 0.13171    0.01671   7.882 3.33e-15 ***
#> X2 0.15916    0.02002   7.952 1.78e-15 ***
#> 
#> Fractional probit regression (Fractional Component):
#> 
#> Note: Standard errors computed using the Delta method
#>      dy/dx Std. Error z value Pr(>|z|)    
#> X1 0.15998    0.01045   15.31   <2e-16 ***
#> X2 0.15678    0.01223   12.82   <2e-16 ***
#> 
#> -------------------------------------------------------------------------------- 
...
#> Note: Standard errors computed using the Delta method
#>       dy/dx Std. Error z value Pr(>|z|)
#> X1 0.011060   0.016269   0.680    0.497
#> X2 0.007363   0.018544   0.397    0.691
#> 
#> Binary probit regression (Pr(y = 1 | y > 0)):
#> 
#> Note: Standard errors computed using the Delta method
#>      dy/dx Std. Error z value Pr(>|z|)    
#> X1 0.13410    0.02177   6.160 7.27e-10 ***
#> X2 0.13775    0.02490   5.531 3.18e-08 ***
#> 
#> Fractional logit regression (Fractional Component):
#> 
#> Note: Standard errors computed using the Delta method
#>      dy/dx Std. Error z value Pr(>|z|)    
#> X1 0.16205    0.01122   14.45   <2e-16 ***
#> X2 0.15377    0.01317   11.67   <2e-16 ***
#> 
#> -------------------------------------------------------------------------------- 
