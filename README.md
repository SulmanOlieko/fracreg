...
[![Development
version](https://img.shields.io/badge/devel%20version-1.1.0-darkred.svg)](https://github.com/SulmanOlieko/fracreg)
[![CRAN
...
7.  **Analytical Partial Effects**: Compute exact marginal effects for
    ...
    functions (e.g., `fracreg.pe()`, `fracregpd.pe()`,
    `fracreghet.pe()`, `fracregridge.pe()`, and `fracregmlogit.pe()`).
8.  **Native S3 Integration & NA Handling**: Provides standard
    extractors (`coef()`, `predict()`, `fitted()`, `residuals()`,
    `vcov()`, `logLik()`, `nobs()`) and native `na.action` missing data
    handling across all estimators.
...
($0 \le y \le 1$). The examples below demonstrate both empirical 401(k)
plan participation data and general simulated boundaries.
...
Toggle to see the output
    ...
    #> (Intercept)     0.730432        0.064200  11.377  < 2e-16 ***
    #> houseval       -0.131351        0.036779  -3.571 0.000355 ***
    #> popdens        -0.004797        0.020959  -0.229 0.818963    
    #> noleft          0.087692        0.045501   1.927 0.053951 .  
    #> minorityleft    0.192296        0.044135   4.357 1.32e-05 ***
    #> tot             0.002264        0.001230   1.841 0.065675 .  
    #> ---
    #> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    #> 
    #> -------------------------------------------------------------------------------- 
    #>                                Choice: education 
    #> -------------------------------------------------------------------------------- 
    #> Wald chi2(5):                                                           287.4998 
    #> Prob > chi2:                                                              0.0000 
    #> -------------------------------------------------------------------------------- 
    #>              Coefficient Robust Std.Err. z value Pr(>|z|)    
    #> (Intercept)    1.1827206       0.1661415   7.119 1.09e-12 ***
    #> houseval      -0.6211415       0.1082111  -5.740 9.46e-09 ***
    #> popdens        0.0649862       0.0332356   1.955   0.0505 .  
    #> noleft        -0.3564544       0.0915540  -3.893 9.89e-05 ***
    #> minorityleft   0.0444723       0.0934246   0.476   0.6341    
    #> tot            0.0035277       0.0004931   7.154 8.40e-13 ***
    #> ---
    #> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    #> 
    #> -------------------------------------------------------------------------------- 
    #>                                Choice: recreation 
    #> -------------------------------------------------------------------------------- 
    #> Wald chi2(5):                                                           211.0906 
    #> Prob > chi2:                                                              0.0000 
    #> -------------------------------------------------------------------------------- 
    #>              Coefficient Robust Std.Err. z value Pr(>|z|)    
    #> (Intercept)    0.3960000       0.0665687   5.949 2.70e-09 ***
    #> houseval      -0.2189675       0.0400569  -5.466 4.59e-08 ***
    #> popdens        0.0498014       0.0173550   2.870  0.00411 ** 
    #> noleft         0.0204284       0.0428769   0.476  0.63376    
    #> minorityleft   0.2264659       0.0416128   5.442 5.26e-08 ***
    ...
    #> -------------------------------------------------------------------------------- 
    #>              Coefficient Robust Std.Err. z value Pr(>|z|)    
    #> (Intercept)    1.6604287       0.1105264  15.023  < 2e-16 ***
    #> houseval      -0.5957548       0.0653649  -9.114  < 2e-16 ***
    #> popdens        0.1571054       0.0226909   6.924  4.4e-12 ***
    #> noleft        -0.1364837       0.0598455  -2.281   0.0226 *  
    #> minorityleft   0.1467280       0.0592470   2.477   0.0133 *  
    ...
    #> -------------------------------------------------------------------------------- 
    #> Wald chi2(5):                                                           216.0171 
    #> Prob > chi2:                                                              0.0000 
    #> -------------------------------------------------------------------------------- 
    #>              Coefficient Robust Std.Err. z value Pr(>|z|)    
    #> (Intercept)    0.9281219       0.1247764   7.438 1.02e-13 ***
    #> houseval      -0.1500441       0.0746389  -2.010  0.04440 *  
    #> popdens        0.1110774       0.0384526   2.889  0.00387 ** 
    #> noleft         0.0433819       0.0830757   0.522  0.60153    
    #> minorityleft   0.2500335       0.0766200   3.263  0.00110 ** 
    #> tot            0.0050419       0.0006371   7.914 2.44e-15 ***
    #> ---
    #> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    #> 
    #> -------------------------------------------------------------------------------- 
    #>                          Run Date: 2026-08-08 17:45:05 
    #> --------------------------------------------------------------------------------
...
Toggle to see the output
    ...
    #> -------------------------------------------------------------------------------- 
    #>                   dy/dx Std. Error z value Pr(>|z|)   
    #> noleft        0.0003228  0.0027536   0.117  0.90669   
    #> minorityleft -0.0073189  0.0026058  -2.809  0.00497 **
    #> ---
    #> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    #> 
    #> -------------------------------------------------------------------------------- 
    ...
    #> minorityleft 0.004872   0.008290   0.588   0.5567  
    #> ---
    #> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    #> 
    #> -------------------------------------------------------------------------------- 
    ...
    #> -------------------------------------------------------------------------------- 
    #>                  dy/dx Std. Error z value Pr(>|z|)  
    #> noleft       -0.017494   0.009576  -1.827   0.0677 .
    #> minorityleft -0.017209   0.010104  -1.703   0.0885 .
    #> ---
    #> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    #> 
    #> -------------------------------------------------------------------------------- 
    ...
    #> -------------------------------------------------------------------------------- 
    #>                 dy/dx Std. Error z value Pr(>|z|)
    #> noleft       0.005778   0.005672   1.019    0.308
    #> minorityleft 0.005583   0.005503   1.015    0.310
    #> 
    #> -------------------------------------------------------------------------------- 
    #>                                  Choice: social 
    #> -------------------------------------------------------------------------------- 
    #>                  dy/dx Std. Error z value Pr(>|z|)   
    #> noleft       -0.032389   0.012081  -2.681  0.00734 **
    #> minorityleft -0.004287   0.012055  -0.356  0.72216   
    #> ---
    #> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    #> 
    #> -------------------------------------------------------------------------------- 
...
Toggle to see the output
    ...
    #>        Coefficient Std. Error z value Pr(>|z|)
    #> noleft  -0.0029002  0.1231033 -0.0236   0.9812
    #> 
    #> -------------------------------------------------------------------------------- 
    #>                          Run Date: 2026-08-08 17:45:05 
    #> --------------------------------------------------------------------------------
...
<img src="man/figures/README-fracregmlogit_wtp-1.png" alt="" width="100%" />
<details>
...
responses bounded between $[0,1]$, regardless of inflation, endogeneity,
unobserved panel effects, multinomial structure, or multicollinearity.
