...
#> Note: Standard errors computed using the Delta method
#>      dy/dx Std. Error z value Pr(>|z|)    
#> X1 0.12971    0.01667   7.781 7.11e-15 ***
#> X2 0.15998    0.01977   8.091 6.66e-16 ***
#> 
#> Fractional probit regression (Fractional Component):
#> 
#> Note: Standard errors computed using the Delta method
#>      dy/dx Std. Error z value Pr(>|z|)    
#> X1 0.16048    0.01043   15.39   <2e-16 ***
#> X2 0.15550    0.01249   12.45   <2e-16 ***
#> 
#> -------------------------------------------------------------------------------- 
...
#> Note: Standard errors computed using the Delta method
#>       dy/dx Std. Error z value Pr(>|z|)
#> X1 0.008828   0.016125   0.548    0.584
#> X2 0.020029   0.018916   1.059    0.290
#> 
#> Binary probit regression (Pr(y = 1 | y > 0)):
#> 
#> Note: Standard errors computed using the Delta method
#>      dy/dx Std. Error z value Pr(>|z|)    
#> X1 0.13377    0.02181   6.133 8.62e-10 ***
#> X2 0.14010    0.02500   5.604 2.10e-08 ***
#> 
#> Fractional logit regression (Fractional Component):
#> 
#> Note: Standard errors computed using the Delta method
#>      dy/dx Std. Error z value Pr(>|z|)    
#> X1 0.16258    0.01124   14.47   <2e-16 ***
#> X2 0.15415    0.01344   11.47   <2e-16 ***
#> 
#> -------------------------------------------------------------------------------- 
