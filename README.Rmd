...
[![Development version](https://img.shields.io/badge/devel%20version-1.1.0-darkred.svg)](https://github.com/SulmanOlieko/fracreg)
...
8. **Native S3 Integration & NA Handling**: Provides standard extractors (`coef()`, `predict()`, `fitted()`, `residuals()`, `vcov()`, `logLik()`, `nobs()`) and native `na.action` missing data handling across all estimators.
